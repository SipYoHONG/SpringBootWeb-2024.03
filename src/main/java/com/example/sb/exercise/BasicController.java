...
public class BasicController {
	...
	@GetMapping("params2")
	public String params2(Model model, HttpServletRequest req) {	// file 올릴땐 	multiparthttpservletrequest이걸 사용한다.
	...
	public String loginProc(String uid, String pwd, HttpSession session, Model model) {
		String hashedPwd = "$2a$10$v4gsa3epdxsZ3Qu/adAMCO9jptg4CKPsiwStkItLOW0LwJ6f6yi06";
